...
Find the source code here: [Blackyezi/XrayR](https://github.com/Blackyezi/XrayR)

# 面板节点设置

[教程](https://github.com/Blackyezi/XrayR/blob/master/README.md)
...
```
1. `git clone https://github.com/Blackyezi/xray`
2. `cd xray`
3. 编辑config。
