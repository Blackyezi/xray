...
install_XrayR() {
    ...
    if  [ $# == 0 ] ;then
        ...
        wget -N --no-check-certificate -O /usr/local/XrayR/XrayR-linux-64.zip https://github.com/amfiyong/XrayR/releases/download/${last_version}/XrayR-linux-64.zip
        if [[ $? -ne 0 ]]; then
        ...
        last_version=$1
        url="https://github.com/amfiyong/XrayR/releases/download/${last_version}/XrayR-linux-64.zip"
