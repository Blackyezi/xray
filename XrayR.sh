...
install_XrayR() {
    ...
    if  [ $# == 0 ] ;then
        ...
        wget -q -N --no-check-certificate -O /usr/local/XrayR/XrayR-linux.zip https://github.com/Blackyezi/XrayR/releases/download/${last_version}/XrayR-linux-${arch}.zip
        if [[ $? -ne 0 ]]; then
        ...
        last_version=$1
        url="https://github.com/Blackyezi/XrayR/releases/download/${last_version}/XrayR-linux-${arch}.zip"
    ...
    file="https://github.com/Blackyezi/XrayR-script/raw/master/XrayR.service"
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/Blackyezi/XrayR-script/master/XrayR.sh
